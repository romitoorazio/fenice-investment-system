...
// Data gate: certification fails closed if any critical provider is unavailable.
...
// Global scanner: meaningful breadth across asset classes with reproducible numeric scores.
...
// Risk engine: always fail closed and never permit autonomous/live execution.
...
// Committee invariants: bounded exposure, explicit invalidation and no hidden order creation.
...
// Paper/audit validation: enough longitudinal history and checkpoints to measure decisions.
