...
export function executionMatchesPaperFxEvidence(execution, fxEvaluation) {
  ...
  const sameProvider = !executionProvider || executionProvider === evidenceProvider;
  ...
  const sameObservedAt = executionObservedMs === null || executionObservedMs === evidenceObservedMs;
