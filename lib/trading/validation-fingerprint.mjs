...
// data, broker read-only boundaries, routing, baseline eligibility,
// certification and the workflows that define the validation claim are all
// part of the immutable baseline.
