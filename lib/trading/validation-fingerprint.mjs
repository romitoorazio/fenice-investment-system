...
// evidence artifacts are deliberately excluded; the code and static registries
// that produce/evaluate them are fingerprinted instead.
export const PAPER_VALIDATION_CORE_FILES = [
  ...
  ".github/workflows/paper-validation-bootstrap-v2.yml",
