...
export function computeIntelligenceConfidence({
  ...
  const criticalGreen = criticalHealth?.gate === "GREEN" && totalCritical > 0 && readyCritical === totalCritical;
  ...
  // Fail-closed confidence caps: no score can hide missing critical evidence.
